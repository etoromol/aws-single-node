...
# Variables below contain multiple ec2-instances
# in form of template so you can customize them 
# to fit your needs.

variable "vm1" {
  description = "Cisco Catalyst 8000V Edge Instance - BYO with IOS XE 17.4.1b"
  type        = map(any)
  default = {
    "name"              = "cat8000vm1"
...
variable "vm2" {
  description = "Cisco Catalyst 8000V Edge Instance - BYO with IOS XE 17.05.1a"
  type        = map(any)
  default = {
    "name"              = "cat8000vm2"
...
variable "vm3" {
  description = "Cisco Cloud Services Router 1000V Instance with IOS XE 17.3.3"
  type        = map(any)
  default = {
    "name"              = "csr1000vm1"
...
variable "vm4" {
  description = <<EOT
                Cisco Cloud Services Router 1000V Instance - Security Pkg. Max 
